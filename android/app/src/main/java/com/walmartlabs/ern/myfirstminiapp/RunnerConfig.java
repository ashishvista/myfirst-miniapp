package com.walmartlabs.ern.myfirstminiapp;

import com.walmartlabs.ern.container.miniapps.MyfirstMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MyfirstMiniappActivity.class;
